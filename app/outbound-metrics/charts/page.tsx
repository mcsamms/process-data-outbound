...
export default function OutboundChartsPage() {
  return (
    <main className="min-h-screen p-8 flex flex-col gap-8 font-sans text-slate-900 dark:text-slate-100 max-w-6xl">
      <header className="space-y-2">
        ...
        <nav className="flex gap-4 text-sm">
          <a className="underline hover:no-underline" href="/outbound-metrics">
            ← Metrics Tables
          </a>
