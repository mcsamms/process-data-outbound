...
export default function OutboundTouchMetricsPage() {
  return (
    <main className="min-h-screen p-8 flex flex-col gap-10 font-sans text-slate-100 max-w-6xl">
      ...
      <section>
        <a
          href="/charts"
          className="underline text-sm text-slate-100 hover:text-white hover:no-underline"
        >
